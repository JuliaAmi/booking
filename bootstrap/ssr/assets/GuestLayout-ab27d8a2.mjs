import { c as checkIsInternalURL } from "./helpers-5224295f.mjs";
import { useSSRContext, resolveComponent, withCtx, createTextVNode, toDisplayString } from "vue";
import { ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderAttrs, ssrRenderSlot } from "vue/server-renderer";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.mjs";
import { A as AuthUser } from "./AuthUser-6fb0c5dc.mjs";
const MenuItemComponent_vue_vue_type_style_index_0_scoped_d2ed9c9c_lang = "";
const _sfc_main$2 = {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList($props.menu, (item) => {
    _push(`<li data-v-d2ed9c9c>`);
    if (item.url !== "") {
      _push(`<!--[-->`);
      if ($options.checkIsInternalURL(item.url)) {
        ...
        _push(`<a${ssrRenderAttr("href", item.url)} target="_blank" data-v-d2ed9c9c>${ssrInterpolate(item.title)}</a>`);
      }
      _push(`<!--]-->`);
    } else {
      _push(`<span data-v-d2ed9c9c>${ssrInterpolate(item.title)}</span>`);
    }
    if (item.children.length) {
      _push(`<ul data-v-d2ed9c9c>`);
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Share/Guest/Menu/MenuItemComponent.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const MenuItemComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-d2ed9c9c"]]);
const _sfc_main$1 = {
  name: "MenuComponent",
  components: {
    MenuItemComponent
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Share/Guest/Menu/MenuComponent.vue");
